...
echo ""
echo "# Run troubleshooting scripts:"
...
echo "bash scripts/run-on-nodes.sh $CLUSTER_NAME $RESOURCE_GROUP $LOCATION check-kubelet-config.sh"
echo "bash scripts/run-on-nodes.sh $CLUSTER_NAME $RESOURCE_GROUP $LOCATION troubleshoot-configure-node.sh"
echo "bash scripts/run-on-nodes.sh $CLUSTER_NAME $RESOURCE_GROUP $LOCATION manual-setup.sh"